#НЕ НАШЕЛ АВТОРА СЕЯ ПРОИЗВЕДЕНИЯ, ДА И САМ ВПЕРВЫЕ ЗАЛИВАЮ. Так что простите за плагиат :(

# Zapret (обход блокировки Discord'а, Youtube'а и Сloudflare'a)
> [!CAUTION]  
...
- **`FIXe.bat`** - запустить обход дискорда, ютуба и cloudflare.
###
